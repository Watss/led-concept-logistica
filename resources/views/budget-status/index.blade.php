<x-app-layout>
    <div class="mb-3 d-flex justify-content-between">
        ...
        <a role="button" href="{{route('budget-status.create')}}" type="button" class="btn btn-primary btn-dark d-flex text-white align-items-center justify-content-center" style="border-radius: 20px;" >
