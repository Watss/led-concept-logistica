<x-app-layout>
    <div class="mb-3 d-flex justify-content-between">
        ...
        @can('user:create')
        <a role="button" href="{{route('users.create')}}" type="button" class="btn text-white btn-primary btn-dark d-flex align-items-center justify-content-center" style="border-radius: 20px;" >
