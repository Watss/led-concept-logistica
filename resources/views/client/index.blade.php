<x-app-layout>
    <div class="mb-3 d-flex justify-content-between">
        ...
        @can('client:create')
        <a role="button" href="{{route('clients.create')}}" type="button" class="btn btn-primary  text-white btn-dark d-flex align-items-center justify-content-center" style="border-radius: 20px;" >
